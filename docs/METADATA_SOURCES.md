...
| UEFA Champions League | Official UEFA fixture feed | competition `1` |
...
Custom promotions select a named source definition. Official UEFA, API-Football, TheSportsDB,
...
Initial adapters: official UEFA, API-Football, TheSportsDB, official ONE, official MLB, football-data.org, TMDB,
