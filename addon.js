...
function renderAccountPage(user, opts) {
  ...
  const body = ''
    ...
    +       '<div class="pipeline-backend"><div class="d-flex justify-content-between gap-2 mb-2"><div><h4 class="h4 mb-1">Native NNTP</h4><div class="text-secondary small">Instant range streaming for direct MKV/MP4 posts; archive support is in progress.</div></div><span class="badge bg-azure-lt align-self-start">Preview</span></div>'
