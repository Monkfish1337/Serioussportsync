...
function f1TitleSession(title) {
  ...
  if (/paddock|uncut|warm[\s._-]*up|build[\s._-]*up|pre[\s._-]*race|post[\s._-]*race|notebook|press[\s._-]*conference|highlights|analysis|debrief|chequered[\s._-]*flag|f1[\s._-]*show/.test(t)) {
    return 'other';
  }
