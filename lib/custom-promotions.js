...
function normaliseSpec(spec) {
  ...
  const out = {
    ...
    promotionAliases: dedupeText(
      Array.isArray(spec.promotionAliases) ? spec.promotionAliases : []
    ),
    exclusionKeywords: dedupeLower(
      Array.isArray(spec.exclusionKeywords) ? spec.exclusionKeywords : []
    ),
