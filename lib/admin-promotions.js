...
async function researchAliases(userConfig, body, opts) {
  ...
  } else if (prowlarrConfig.url && prowlarrConfig.apiKey && prowlarrConfig.enabled !== false) {
  ...
  if (companionConfig && companionConfig.url && !require('./prowlarr-discovery').usesQueue(draft.promotion)) {
