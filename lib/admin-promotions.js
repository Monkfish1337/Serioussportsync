        ...
        <form method="POST" action="${escapeHtml(formAction)}" id="promotionWizardForm">
          ...
          <div class="row">
            ...
            <div class="col-md-3 mb-2">
              ...
              <small class="text-secondary d-block">Skips UU's direct event-title search and playback.</small>
            </div>
            <div class="col-md-3 mb-2">
              <label class="form-check">
                <input class="form-check-input" type="checkbox" name="disablePipelineDiyUsenet" value="1"${(ed.disabledPipelines && ed.disabledPipelines.indexOf('diy-usenet') !== -1) ? ' checked' : ''}>
...
function persistFromForm(body, opts) {
  ...
  const spec = {
    ...
    disabledPipelines: [
      ...
      body.disablePipelineDiyUsenet === '1' ? 'diy-usenet' : null,
