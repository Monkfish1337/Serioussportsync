          ...
          <div class="card bg-dark-lt mb-3">
            <div class="card-body">
              ...
              <div class="card border-info mb-3"><div class="card-body">
                <div class="d-flex flex-wrap align-items-start justify-content-between gap-3 mb-3"><div><h4 class="mb-1">Alias Research</h4><div class="text-secondary small">SSS searches Companion's TorBox discovery sources plus the search services configured on your account, tests every discovered title against this promotion, and explains what matched or was rejected. Credentials, hashes, and download links never leave the server.</div></div><span class="badge bg-blue-lt">admin only</span></div>
