...
async function researchAliases(userConfig, body, opts) {
  ...
  if (require('./prowlarr-discovery').usesQueue(draft.promotion) && !opts.prowlarrSearch) {
  ...
  } else if (prowlarrConfig.url && prowlarrConfig.apiKey && prowlarrConfig.enabled !== false && prowlarrConfig.liveSearchEnabled !== false) {
