    ...
    <div class="card mb-4">
      ...
      <div class="table-responsive">
        <table class="table card-table align-top">
          <thead><tr><th class="w-1"><input class="form-check-input m-0" type="checkbox" id="promotionSelectAll" aria-label="Select every enabled promotion"></th><th>Kind</th><th>Name</th><th>Metadata source</th><th>Poster</th><th>Events</th><th>Catalogs</th><th class="w-1"></th></tr></thead>
          <tbody>${rows}</tbody>
        </table>
      </div>
    </div>
