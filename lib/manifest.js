...
function buildManifest(opts) {
  ...
  // DIY requires a configured discovery source and at least one configured
  // playback backend. Native NNTP is independent of NZB DAV, so either can
  // make the pipeline usable.
