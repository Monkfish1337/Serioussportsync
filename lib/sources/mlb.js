...
function toRaw(game) {
  ...
  return {
    ...
    // Discovery and its coverage report skip cancelled and postponed games by
    // this field; carried only in the description, a rainout counted as a
    // missing release forever.
    status: status || null,
