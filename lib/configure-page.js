...
function stepServices(cfg, isAdmin) {
  ...
  return ''
    ...
    + serviceCard({
      ...
      body: !isAdmin ? '<div class="hint">Available to administrators only because this pipeline uses server resources.</div><input type="checkbox" disabled aria-label="DIY Usenet is admin only">' : toggle('diyUsenetEnabled', diyOn, 'Enable the DIY Usenet pipeline',
