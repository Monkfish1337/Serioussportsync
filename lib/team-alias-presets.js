...
// NHL, from ESPN's own team list (2026-09-25: 32 teams, including the Utah
// Mammoth, which releases from the 2024-25 season still call Utah Hockey Club).
// Same policy as the big three: nicknames lead, and a city shared inside the
// league is left out — "New York" is both Islanders and Rangers. ESPN's
// two-letter codes (LA, NJ, SJ, TB) are too short to be safe as search terms,
// so the common three-letter forms stand in for them.
const NHL = {
  ...
  'Columbus Blue Jackets': ['Blue Jackets', 'Columbus', 'CBJ'],
  'Dallas Stars': ['Stars', 'Dallas', 'DAL'],
  'Detroit Red Wings': ['Red Wings', 'Detroit', 'DET'],
  ...
  'Montreal Canadiens': ['Canadiens', 'Montreal', 'Montréal Canadiens', 'MTL', 'Habs'],
  'Nashville Predators': ['Predators', 'Nashville', 'NSH', 'Preds'],
  'New Jersey Devils': ['Devils', 'New Jersey', 'NJ Devils', 'NJD'],
  'New York Islanders': ['Islanders', 'NY Islanders', 'NYI', 'Isles'],
  'New York Rangers': ['Rangers', 'NY Rangers', 'NYR'],
  'Ottawa Senators': ['Senators', 'Ottawa', 'OTT', 'Sens'],
  'Philadelphia Flyers': ['Flyers', 'Philadelphia', 'PHI'],
  ...
  'Tampa Bay Lightning': ['Lightning', 'Tampa Bay', 'Tampa', 'TBL', 'Bolts'],
  'Toronto Maple Leafs': ['Maple Leafs', 'Toronto', 'TOR', 'Leafs'],
  'Utah Mammoth': ['Mammoth', 'Utah', 'Utah Hockey Club', 'Utah HC', 'UTA'],
