...
async function prefetchAvailability(params) {
  ...
  //
  // Measured Prowlarr discovery for MLB/NBA/NFL runs separately, with its own
  // persistent queue and budgets. Never fan those leagues out from this bulk
  // warmer, even if the legacy all-sources override is enabled.
