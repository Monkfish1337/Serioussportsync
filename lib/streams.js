...
async function prefetchAvailability(params) {
  ...
  if (!disabled.has('torbox') && !skipProviders.has('torrent')) {
  ...
  if (uuConfig && !skipProviders.has('uu')
  ...
  if (!disabled.has('diy-usenet') && !skipProviders.has('native-indexer')
  ...
  const easynewsCreds = userConfig.easynewsUsername && userConfig.easynewsPassword
    ...
    : null;
  if (!disabled.has('easynews') && !skipProviders.has('easynews')
