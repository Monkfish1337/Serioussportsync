...
const jsonFeed = require('./sources/json-feed');
...
const SYSTEM_SOURCES = Object.freeze([
  ...
  { id: 'api-football-ucl', name: 'API-Football · UEFA Champions League', system: true, source: { type: 'api-football', leagueId: '2' } },
]);
const SYSTEM_ASSIGNMENTS = Object.freeze({
  ...
  motd: 'tmdb-motd', manutd: 'football-data-manutd', ucl: 'api-football-ucl',
});
