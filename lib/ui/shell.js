...
function destinations(isAdmin) {
  ...
  if (isAdmin) {
    items.push(
      ...
      { id: 'usenet', label: 'Usenet', href: '/admin/usenet', icon: 'usenet' },
      { id: 'promotions', label: 'Promotions', href: '/admin/promotions', icon: 'promotions' },
      { id: 'events', label: 'Event Editor', href: '/admin/events', icon: 'events' },
      { id: 'discovery', label: 'Discovery', href: '/admin/discovery', icon: 'database' },
      { id: 'nuvio-collections', label: 'Collections', href: '/admin/nuvio-collections', icon: 'collections' },
      { id: 'user-management', label: 'User Management', href: '/admin/user-management', icon: 'account' },
      { id: 'metadata', label: 'Metadata', href: '/admin/metadata', icon: 'metadata' },
      { id: 'database', label: 'Database', href: '/admin/database', icon: 'database' },
      { id: 'client-check', label: 'Client check', href: '/admin/client-check', icon: 'check' },
      { id: 'logs', label: 'Logs', href: '/admin/logs', icon: 'logs' },
      { id: 'backup', label: 'Backup', href: '/admin/backup', icon: 'backup' }
    );
  }
  return items;
}
...
function rail(current, user, isAdmin) {
  ...
  return ''
    ...
    + '<span class="rail-label">Log out ' + escapeHtml(name) + '</span>'
    + '</button></form>'
    + '</nav>';
}
