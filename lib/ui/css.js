...
.rail {
  ...
  gap: 4px; padding: 14px 10px; position: sticky; top: 0; height: 100vh; overflow-y: auto;
}
.rail-mark {
  width: 52px; height: 52px; display: block; flex-shrink: 0;
  margin-bottom: 8px; text-decoration: none;
}
.rail-mark img { display: block; width: 100%; height: 100%; object-fit: contain; }
.rail-btn {
  position: relative; width: 100%; min-height: 40px; flex-shrink: 0; padding: 10px 12px;
  display: flex; align-items: center; text-align: left; font: inherit; font-size: 14px;
...
/* A picked team needs to be findable among thirty tiles, not merely different
   once you compare two of them side by side. */
.team-tick { margin-left: auto; flex: none; color: var(--accent); font-weight: 700; visibility: hidden; }
.team[aria-pressed="true"] .team-tick { visibility: visible; }
...
${options.compat === false ? '' : compat.compatCss()}
@media (max-width: 820px) {
  ...
  .rail-btn, .rail form { width: auto; white-space: nowrap; flex-shrink: 0; }
