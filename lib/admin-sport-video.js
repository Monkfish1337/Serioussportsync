...
function renderBody(data) {
  ...
  return flash
    ...
    + '<div class="row mt-3"><div class="col-sm-6"><label class="form-label">Archive pages per scan</label>'
      ...
      + '<div class="form-hint">The per-sport pages list only a short recent window. The dated archive holds the rest — about 60 releases per page, newest first. Set 0 to read the sport pages only.</div></div></div></div>'
